...
async function testSnakeCaseQuery() {
    console.log("Testing snake_case to camelCase translation...");
    ...
    // Using the exact snake_case that the AI generates
    const body = {
        connectionId: connectionId,
        query: "SELECT timestamp, AVG(cpu_usage) as avg_cpu FROM orion_metrics GROUP BY timestamp ORDER BY timestamp ASC"
    };
    ...
    try {
        ...
        if (response.ok) {
            ...
            console.log("✅ Success! Snake_case query translated and executed.");
